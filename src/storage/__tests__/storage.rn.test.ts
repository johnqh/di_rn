...
describe('RNStorage', () => {
  ...
  beforeEach(() => {
    // Inject mock before creating storage instance
  ...
  describe('getItem', () => {
    it('should return value from AsyncStorage', async () => {
      (mockAsyncStorage.getItem as Mock).mockResolvedValueOnce('storedValue');
    ...
    it('should return null when key does not exist', async () => {
      (mockAsyncStorage.getItem as Mock).mockResolvedValueOnce(null);
  ...
  describe('getAllKeys', () => {
    it('should return all keys from AsyncStorage', async () => {
      (mockAsyncStorage.getAllKeys as Mock).mockResolvedValueOnce([
        'key1',
        'key2',
      ]);
...
describe('AdvancedRNStorage', () => {
  ...
  describe('getItem with TTL', () => {
    it('should return value if not expired', async () => {
      ...
      (mockAsyncStorage.getItem as Mock).mockResolvedValueOnce(
