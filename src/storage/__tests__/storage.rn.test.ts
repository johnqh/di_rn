...
import { RNStorage, AdvancedRNStorage } from '../storage.rn.js';
...
describe('RNStorage', () => {
  ...
  describe('getItem', () => {
    it('should return value from AsyncStorage', async () => {
      (AsyncStorage.getItem as Mock).mockResolvedValueOnce('storedValue');
  ...
  describe('getAllKeys', () => {
    it('should return all keys from AsyncStorage', async () => {
      (AsyncStorage.getAllKeys as Mock).mockResolvedValueOnce(['key1', 'key2']);
...
describe('AdvancedRNStorage', () => {
  ...
  describe('clearPattern', () => {
    it('should remove items matching pattern', async () => {
      (AsyncStorage.getAllKeys as Mock).mockResolvedValueOnce([
        'user_123',
        'user_456',
        'config_abc',
      ]);
