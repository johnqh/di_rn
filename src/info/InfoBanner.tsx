/**
 * React Native components for InfoInterface integration
 *
...
import { Banner } from '@sudobility/components-rn';
import { getInfoService, type BannerState } from './info.rn.js';
